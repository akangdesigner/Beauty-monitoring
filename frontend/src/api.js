...
export const api = {
  ...
  runScraperEnabled: () => apiFetch('/api/scraper/run-enabled', { method: 'POST' }),
  ...
  renameProduct:   (id, base_name) => apiFetch(`/api/products/${id}`, { method: 'PATCH', body: JSON.stringify({ base_name }) }),
  ...
  deleteAllProducts: ()            => apiFetch('/api/products/all', { method: 'DELETE' }),
